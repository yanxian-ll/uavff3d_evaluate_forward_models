"""UAVFF3D WAI-format dataset loader for large synthetic UAV scenes."""
...
class UAVFF3DSynLargeWAI(UAVFF3DRealWAI):
    """
    UAVFF3D-Syn-L dataset containing object-centric and birds-eye-view scenes.
    """
...
def get_parser():
    ...
    parser.add_argument(
        "-rd", "--root_dir", default="../../dataset/data/UAVFF3D-Syn-L", type=str
    )
    parser.add_argument(
        "-dmd",
        "--dataset_metadata_dir",
    ...
    parser.add_argument(
        "--app_id",
        type=str,
        default="UAVFF3D-Syn-L_Dataloader",
