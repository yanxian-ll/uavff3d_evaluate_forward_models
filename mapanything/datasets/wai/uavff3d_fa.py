"""UAVFF3D WAI-format dataset loader for controlled HFOV-height ambiguity scenes."""

import os
import numpy as np

from mapanything.datasets.wai.uavff3d_syn_large import UAVFF3DSynLargeWAI


class UAVFF3DFAWAI(UAVFF3DSynLargeWAI):
    """
    UAVFF3D-FA dataset for controlled HFOV-height ambiguity evaluation.
    """
...
def get_parser():
    ...
    parser.add_argument(
        "-rd", "--root_dir", default="../../dataset/data/UAVFF3D-FA", type=str
    )
    parser.add_argument(
        "-dmd",
