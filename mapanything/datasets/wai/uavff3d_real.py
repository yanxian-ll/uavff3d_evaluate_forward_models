"""UAVFF3D WAI-format dataset loader for real UAV scenes."""
...
class UAVFF3DRealWAI(BaseDataset):
    """
    UAVFF3D-Real dataset containing object-centric and birds-eye-view scenes.
    """
    def __init__(
        self,
        *args,
...
def get_parser():
    ...
    parser.add_argument(
        "-rd", "--root_dir", default="../../dataset/data/UAVFF3D-Real", type=str
    )
    parser.add_argument(
        "-dmd",
        "--dataset_metadata_dir",
    ...
    parser.add_argument(
        "--app_id",
        type=str,
        default="UAVFF3D-Real_Dataloader",
