...
class DPTHead(nn.Module):
    ...
    def forward(
        ...
        if frames_chunk_size is None or frames_chunk_size >= S:
            ...
            return self._forward_impl_with_checkpoint(aggregated_tokens_list, images, patch_start_idx)
        ...
        for frames_start_idx in range(0, S, frames_chunk_size):
            ...
            if self.feature_only:
                ...
                #     frames_end_idx,
                # )
                chunk_output = self._forward_impl_with_checkpoint(
                    aggregated_tokens_list, 
                    images, 
                    patch_start_idx,
                    frames_start_idx,
                ...
                #     frames_end_idx,
                # )
                chunk_preds, chunk_conf = self._forward_impl_with_checkpoint(
                    aggregated_tokens_list,
                    images,
                    patch_start_idx,
                    frames_start_idx,
    ...
    def _forward_impl_with_checkpoint(
        self,
        aggregated_tokens_list: List[torch.Tensor],
        images: torch.Tensor,
        patch_start_idx: int,
        ...
        use_ckpt = (
            ...
            and any(x.requires_grad for x in aggregated_tokens_list)
        )
