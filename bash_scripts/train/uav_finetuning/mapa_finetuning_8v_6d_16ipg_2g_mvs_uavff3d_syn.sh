...
torchrun --nproc_per_node ${NUM_GPUS} \
    scripts/train.py \
    machine=aws \
    dataset=uavtrain_uavff3d_syn_518_many_ar_16ipg_2g \
    ...
    hydra.run.dir='${root_experiments_dir}/mapanything/uav_training/mapa_finetuning_16v_6d_16ipg_2g_mvs_uavff3d_syn'
