...
# mapa_depth: 只使用mapa补全的深度
# mapa_depth_V2: 部分使用mapa补全的深度，当补全深度效果差时，才使用mapa补全的深度
...
torchrun --nproc_per_node ${NUM_GPUS} \
    ...
    dataset.a3dscenes_wai.train.load_modalities=["image","depth_complete"] \
    ...
    model.pretrained='checkpoints/mapa/map-anything.pth' \
    ...
    hydra.run.dir='${root_experiments_dir}/mapanything/training_ablations/mapa_depth_V2'
