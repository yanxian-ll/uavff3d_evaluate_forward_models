...
torchrun --nproc_per_node ${NUM_GPUS} --nnodes ${NUM_NODES} --node_rank ${NODE_RANK} \
    ...
    model.pretrained='${root_experiments_dir}/mapanything/training/mapa_v1_1_apache/checkpoint-last-conf-ft.pth' \
    ...
    hydra.run.dir='${root_experiments_dir}/mapanything/training/mapa_v1_1_apache'
