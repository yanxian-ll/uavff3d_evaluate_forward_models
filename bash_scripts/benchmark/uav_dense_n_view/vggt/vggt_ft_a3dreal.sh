...
for combo in "${batch_sizes_and_views[@]}"; do
    ...
    python3 \
        ...
        model.pretrained='${root_experiments_dir}/mapanything/uav_training/vggt_finetuning_16v_6d_16ipg_2g_a3dreal/checkpoint-best.pth' \
        hydra.run.dir='${root_experiments_dir}/mapanything/benchmarking/dense_'"${num_views}"'_view/vggt_ft_a3dreal'
